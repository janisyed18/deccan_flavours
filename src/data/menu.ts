    ...
    items: [
      {
        ...
        name: "Talawa Gosh",
        price: 26,
        description: "Deccan-style pan-fried mutton with chilli and house spices.",
        dietaryTags: ["H", "S"],
        popular: false,
      ...
      },
      {
        ...
        price: 24,
        description: "Deccan chilli and peanut-sesame curry, a biryani classic.",
        dietaryTags: ["V", "S"],
        popular: false,
    ...
    items: [
      {
        ...
        price: 11,
        description: "Classic Deccan bread pudding with cardamom and rose.",
        dietaryTags: ["V"],
        popular: false,
      ...
      },
      {
        ...
        price: 11,
        description: "Deccan apricot dessert finished rich and sweet.",
        dietaryTags: ["V"],
        popular: false,
        imageUrl: IMAGE.gulabJamun,
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: "Mirchi Ka Salan",
        price: 2,
        description: "Small serve of Deccan chilli salan for biryani.",
        dietaryTags: ["V", "S"],
        popular: false,
        imageUrl: IMAGE.mirchiSalan,
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: 20,
        description: "Tender mutton and long-grain basmati in classic Deccan style.",
        dietaryTags: ["H", "S"],
        popular: true,
        imageUrl: IMAGE.muttonBiryani,
      },
      ...
      },
      {
        ...
        name: "Paya Plate",
        price: 25,
        description: "Slow-cooked paya plate with warming Deccan spices.",
        dietaryTags: ["H", "S"],
        popular: false,
        imageUrl: IMAGE.curry,
      },
