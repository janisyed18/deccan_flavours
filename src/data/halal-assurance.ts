...
export const HALAL_ASSURANCE: HalalAssurance = {
  ...
  summary:
    "Deccan Flavours Wentworthville is publicly listed as a fully halal Deccan restaurant. We keep this promise visible, practical and source-backed for families choosing where to dine.",
  certificateUrl: null,
  ...
  assurances: [
    ...
    },
    {
      ...
      description: "The restaurant is presented online as a halal Indian and Deccan dining option for Wentworthville families.",
    },
    {
  ...
  evidence: [
    {
      ...
      href: "https://halalhq.io/au/nsw/wentworthville/restaurants/deccan-flavours",
    },
    {
      source: "Facebook",
