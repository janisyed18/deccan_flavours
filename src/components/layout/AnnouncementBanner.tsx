...
export function AnnouncementBanner() {
  ...
  return (
    <div className="border-b border-turmeric-300/25 bg-forest-900 text-white">
      <div className="container flex min-h-11 items-center gap-3 py-2 text-sm font-bold">
        <Megaphone aria-hidden className="h-4 w-4 text-turmeric-300" />
        <span className="font-black text-turmeric-100">{announcements[0].title}</span>
