      ...
      <div className="container">
        <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 rounded bg-forest-900 px-4 py-3 text-sm font-black text-white transition hover:bg-forest-700">
              ...
              <details key={faq.question} className="group rounded border border-black/8 bg-white p-5 shadow-sm" open={index === 0}>
                <summary className="cursor-pointer list-none text-lg font-black leading-tight text-ink">
                  <span className="flex items-start justify-between gap-4">
                    {faq.question}
                    <span className="mt-1 grid h-6 w-6 shrink-0 place-items-center rounded bg-turmeric-100 text-sm text-forest-900 transition group-open:rotate-45">
                      +
                    </span>
                  </span>
                </summary>
