    ...
    <section className="bg-background py-16 md:py-24">
      <div className="container">
        <div className="mb-10 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          <div className="rounded border border-turmeric-300 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-2 text-3xl font-black text-forest-900">
              <Star aria-hidden className="h-7 w-7 fill-turmeric-300 text-turmeric-300" />
            ...
            <article key={`${review.authorName}-${review.relativeTimeDescription}`} className="rounded border border-black/8 bg-white p-5 shadow-sm">
              <div className="mb-4 flex items-center gap-3">
                {review.profilePhotoUrl ? (
                  ...
                  <span className="grid h-10 w-10 place-items-center rounded-full bg-forest-900 text-sm font-black text-turmeric-300">
              ...
              <div className="mb-3 flex text-turmeric-500" aria-label={`${review.rating} out of 5 stars`}>
              ...
              <details>
                <summary className="cursor-pointer list-none text-sm leading-6 text-charcoal/76">
                  ...
                  <span className="mt-2 inline-block text-xs font-black uppercase tracking-[0.18em] text-forest-700">Read more</span>
                </summary>
