    ...
    <section className="border-y border-black/8 bg-white py-8" aria-labelledby="recognition-heading">
      <div className="container">
        <div className="grid gap-5 lg:grid-cols-[280px_minmax(0,1fr)] lg:items-center">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.22em] text-turmeric-700">Recognition</p>
            ...
            {RECOGNITION_ITEMS.map((item, index) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group flex min-h-36 flex-col justify-between rounded border border-black/8 bg-background p-4 transition hover:-translate-y-0.5 hover:border-turmeric-300 hover:shadow-lift"
                >
                  <span className="mb-5 flex items-start justify-between gap-3">
                    <span className="grid h-10 w-10 place-items-center rounded bg-forest-900 text-turmeric-300">
                      <Icon aria-hidden className="h-5 w-5" />
                    </span>
                    <ArrowUpRight aria-hidden className="h-4 w-4 text-charcoal/35 transition group-hover:text-forest-700" />
                  </span>
                  <span>
