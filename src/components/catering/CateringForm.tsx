  ...
  return (
    <form onSubmit={submit} className="grid gap-5 rounded border border-black/8 bg-white p-5 shadow-lift md:p-6">
      <div className="flex items-center gap-3 border-b border-black/8 pb-5">
        <span className="grid h-11 w-11 place-items-center rounded bg-forest-900 text-turmeric-100">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  active ? "border-forest-900 bg-forest-900 text-white" : "border-black/10 bg-white text-charcoal hover:border-forest-700/40",
                )}
              >
                {item}
              </button>
      ...
      <Field label="Event details">
        <textarea
          name="message"
          rows={5}
          className="w-full rounded border border-black/10 p-3 text-sm font-bold outline-none transition placeholder:text-charcoal/35 focus:border-forest-700 focus:ring-2 focus:ring-forest-700/15"
      ...
      {message ? (
        <p className={cn("rounded p-3 text-sm font-bold", status === "sent" ? "bg-leaf/10 text-leaf" : "bg-forest-50 text-forest-700")}>
      ...
      <button
        ...
        className="inline-flex min-h-12 items-center justify-center gap-2 rounded bg-forest-900 px-5 py-3 text-sm font-black text-white transition hover:bg-forest-700 disabled:bg-charcoal/25"
      >
...
const inputClass = "h-12 w-full rounded border border-black/10 bg-white px-3 text-sm font-bold outline-none transition placeholder:text-charcoal/35 focus:border-forest-700 focus:ring-2 focus:ring-forest-700/15";
