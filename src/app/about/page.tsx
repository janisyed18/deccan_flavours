...
export const metadata: Metadata = {
  title: "About Us",
  description: "The Deccan Flavours story from Hyderabad biryani craft to Western Sydney family dining.",
  alternates: { canonical: "/about" },
};

const values = [
  ["Authentic", "Deccan recipes, dum cooking and spice layering."],
    ...
    <section className="bg-background">
      <div className="container py-12 md:py-18">
        <div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div>
            <p className="mb-3 text-sm font-black uppercase tracking-[0.22em] text-turmeric-700">About Deccan Flavours</p>
            <h1 className="font-display text-6xl font-bold leading-none text-ink md:text-8xl">Deccan Soul, Western Sydney Table</h1>
            <p className="mt-6 text-lg leading-8 text-charcoal/72">
              Deccan Flavours brings the timeless heritage of the Deccan Plateau to Wentworthville — slow-cooked biryanis, rich family curries, and halal hospitality shaped around the local community.
            </p>
            <p className="mt-4 text-lg leading-8 text-charcoal/72">
              Since 2015, the kitchen has focused on the details that make South Indian food memorable: long-grain basmati, patient spice layering, fresh naans and a dining room that welcomes families, students, workers and weekend celebrations alike.
            </p>
          </div>
          <div className="relative aspect-[4/5] overflow-hidden rounded border border-black/8 bg-smoke shadow-lift">
            <Image src="/images/hero-biryani.png" alt="Deccan Flavours biryani handi" fill sizes="(min-width: 1024px) 40vw, 100vw" className="object-cover" />
          </div>
        </div>
        ...
        <div className="mt-16 grid gap-5 md:grid-cols-4">
          {values.map(([title, copy]) => (
            <article key={title} className="rounded border border-black/8 bg-white p-5 shadow-sm">
              <Sparkles aria-hidden className="mb-4 h-5 w-5 text-turmeric-700" />
        ...
        <div className="mt-16 grid gap-6 rounded border border-black/8 bg-white p-6 shadow-sm lg:grid-cols-3">
          ...
          <div>
            <Award aria-hidden className="mb-4 h-8 w-8 text-turmeric-700" />
          ...
          <div>
            <HeartHandshake aria-hidden className="mb-4 h-8 w-8 text-forest-700" />
        ...
        <div className="mt-16">
          <div className="mb-6">
            <p className="mb-3 text-sm font-black uppercase tracking-[0.22em] text-turmeric-700">Gallery</p>
