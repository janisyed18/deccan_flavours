      ...
      <div className="container">
        <div className="mx-auto max-w-3xl rounded border border-white/15 bg-white p-6 text-ink shadow-lift">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-black uppercase tracking-[0.2em] text-forest-700">Payment received</p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-[auto_1fr] md:items-center">
            ...
            <div>
              ...
              <p className="mt-1 break-all text-xl font-black text-forest-700">{orderId}</p>
              <p className="mt-4 text-sm leading-6 text-charcoal/68">Show this QR code at pickup.</p>
            </div>
          </div>
          <OrderSuccessStatus orderId={orderId} />
          <Link href="/menu" className="mt-6 inline-flex rounded bg-forest-900 px-5 py-3 text-sm font-black text-white">
            Back to menu
          </Link>
        </div>
      </div>
