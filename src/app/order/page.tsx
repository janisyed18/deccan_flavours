...
export const metadata: Metadata = {
  ...
  description: "Order Deccan Flavours Wentworthville online for pickup and pay through Stripe Checkout.",
    ...
    <section className="bg-background py-12 md:py-18">
      <div className="mx-auto w-full max-w-[1500px] px-4">
        <div className="mb-10 max-w-3xl">
          <p className="mb-3 text-sm font-black uppercase tracking-[0.22em] text-turmeric-700">Click & Collect</p>
