      ...
      <section className="bg-background py-16">
        <div className="container">
          <div className="mx-auto max-w-xl rounded border border-black/8 bg-white p-6 text-center shadow-lift">
            <p className="mb-3 text-sm font-black uppercase tracking-[0.22em] text-turmeric-700">Admin only</p>
            ...
            <Link href="/admin/login?callbackUrl=/admin" className="mt-6 inline-flex rounded bg-forest-900 px-5 py-3 text-sm font-black text-white">
              Sign in
            </Link>
          </div>
        </div>
    ...
    <section className="min-h-screen bg-background py-6 md:py-8">
      <div className="mx-auto w-full max-w-[1680px] px-4 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-wrap items-end justify-between gap-4 border-b border-black/8 pb-5">
          <div>
            <p className="mb-2 text-xs font-black uppercase tracking-[0.22em] text-turmeric-700">Admin Dashboard</p>
          ...
          <div className="grid gap-3 sm:justify-items-end">
            ...
            <Link href="/admin/kitchen" className="inline-flex min-h-11 items-center justify-center rounded bg-forest-900 px-4 text-sm font-black text-white">
