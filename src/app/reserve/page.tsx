...
export const metadata: Metadata = {
  ...
  description: "Book a table at Deccan Flavours Wentworthville for lunch, dinner, family gatherings and special occasions.",
  ...
  return (
    <section className="bg-background py-12 md:py-18">
      <div className="container grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
        <div>
          <p className="mb-3 text-sm font-black uppercase tracking-[0.22em] text-turmeric-700">Reservations</p>
          ...
          <div className="mt-6 rounded border border-turmeric-300 bg-white p-5 text-sm leading-6 text-charcoal/72">
